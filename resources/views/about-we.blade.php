            ...
            <div
                ...
                <div class="ml-10 flex flex-col justify-center">
                    ...
                    <div class="flex mt-2 gap-5 text-gray-500">
                        ...
                        <a target="_blank" href="https://alwan9.github.io/personal" class="hover:text-pink-500 duration-500 cursor-pointer hover:scale-105">
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24">
                                <path fill="currentColor"
...
<div>
    <div class="px-[5%] md:px-[20%] text-center text-xl lg:mt-[20%]">
...
<marquee behavior="scroll" direction="left" scrollamount="10" onmouseover="this.stop();" onmouseout="this.start();" style="width: 100%; margin-top: 4rem;">
    <span style="display: inline-flex; align-items: center; gap: 2rem;">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://www.unimedia.tech/wp-content/uploads/2023/11/2560px-Logo.min_.svg_-1024x297.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Tailwind_CSS_logo.svg/512px-Tailwind_CSS_logo.svg.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://upload.wikimedia.org/wikipedia/commons/f/fd/JQuery-Logo.svg">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Sql_data_base_with_logo.png/800px-Sql_data_base_with_logo.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://garapmedia.com/wp-content/uploads/2025/01/01J4TYXBRT9FYKKKPTXFVSQE3T.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://cdn.freebiesupply.com/logos/large/2x/git-logo-png-transparent.png">

        {{-- <img class="max-h-[30px] md:max-h-[70px]" src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/flowise.svg"> --}}
        <img class="max-h-[30px] md:max-h-[70px]" src="https://wp.logos-download.com/wp-content/uploads/2017/07/HTML5_logo.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://cdn.freebiesupply.com/logos/large/2x/css3-logo-png-transparent.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://logos-world.net/wp-content/uploads/2023/02/JavaScript-Emblem.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="assets/flowise.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://freepnglogo.com/images/all_img/1706463199figma-logo-png.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://logos-download.com/wp-content/uploads/2016/09/Node_logo_NodeJS.png">
        <img class="max-h-[30px] md:max-h-[120px]" src="https://download.logo.wine/logo/Cloudflare/Cloudflare-Logo.wine.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://logos-world.net/wp-content/uploads/2020/11/GitHub-Emblem.png">
    </span>
</marquee>
<marquee behavior="scroll" direction="right" scrollamount="10" onmouseover="this.stop();" onmouseout="this.start();" style="width: 100%; margin-top: 4rem;">
    <span style="display: inline-flex; align-items: center; gap: 2rem;">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://upload.wikimedia.org/wikipedia/commons/f/fd/JQuery-Logo.svg">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Sql_data_base_with_logo.png/800px-Sql_data_base_with_logo.png">
        <img class="max-h-[30px] md:max-h-[70px]" src="https://garapmedia.com/wp-content/uploads/2025/01/01J4TYXBRT9FYKKKPTXFVSQE3T.png">
    ...
    <div class="  px-[10%] mt-[15%] py-8 lg:grid grid-cols-2 gap-10 relative z-[4]">
        <div>
            ...
            <h2 class="text-2xl lg:text-4xl font-bold text-left mb-6 lg:w-[70%] merriweather text-gradasi">💬 Tanya Jawab Seputar
