...
<div class=" px-[10%] pt-[15%] pb-[15%]">
    ...
    <div class="flex justify-center gap-10 items-center mt-[150px]">
        ...
        <div data-aos="flip-left"
            class=" bg-white shadow-lg hover:bg-zinc-100 duration-300 cursor-pointer rounded-xl overflow-hidden flex items-center px-20  py-5">
            <!-- Foto Kiri -->
            ...
            <div class="ml-10 flex flex-col justify-center">
                ...
                <p class="w-[97%] my-2">Mendesain UI yang menarik dan mengintegrasikan AI ke dalam sistem. Fokus pada
