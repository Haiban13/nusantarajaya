...
<a href="{{ route('acara.show', $acara->id) }}">
    <div class="relative z-[4] card-bg rounded-2xl w-min-[300px] lg:w-min-[500px] shadow-lg hover:bg-orange-100 hover:cursor-pointer overflow-hidden hover:scale-105 bg-orange-50 duration-200">
        ...
        @if ($acara->htm > 0)
            <div class="lg:px-12 px-8 text-xs lg:text-xl py-2 rounded-bl-3xl text-orange-100 shadow-sm bg-red-500 absolute right-0 top-0">Berbayar</div>
        @else
            <div class="px-12 py-2 text-xs lg:text-xl rounded-bl-3xl text-orange-50 shadow-sm bg-green-500 absolute right-0 top-0">Tanpa Biaya</div>
        @endif
