...
<nav
    ...
    <!-- Menu Desktop -->
    <div
        class=" hidden lg:flex lg:block menu-desktop  items-center gap-10 text-zinc-800 text-center justify-self-center ">
    ...
    <div class=" hidden lg:block">
        ...
        <div class="lg:flex items-center gap-3 hidden justify-self-end">
            <div class="flex items-center gap-3">
                <a target="_blank" href="/admin" class="rounded-full duration-200 btn-line text-orange-600 ">Masuk</a>
...
<div id="mobile-menu" class="hidden md:hidden bg-zinc-900/80 w-dvw h-dvh fixed z-[933]">
    ...
    <div
        ...
        <a href="/admin">
            ...
            <div
                class="w-12 h-12 rounded-full bg-orange-500 text-white   lg:flex hover:cursor-pointer justify-self-end   items-center justify-center font-bold">
                {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                {{ auth()->user()->name }}
            </div>
        </a>
        ...
        <div class="lg:flex items-center gap-3   justify-self-end">
            ...
            <a href="{{ route('user.profile') }}">
                {{-- <a href="{{ route('profile.show') }}"> --}}
                <div class="bg-zinc-500 w-[50px]   h-[50px] rounded-full"></div>
            </a>
        </div>
        @endif
