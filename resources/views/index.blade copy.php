     ...
     <div class="w-full">
             ...
             <div class="flex items-center justify-between">
                 <div>
                     <h2 class="text-3xl lg:text-5xl  font-bold text-gray-800 mb-2 merriweather text-gradasi">Acara
                         Terbaru</h2>
                     <p class="text-gray-500 mb-8 menu-desktop md:text-xl">Jangan lewatkan acara-acara budaya paling
                         menarik
                         yang akan datang.
                     </p>
                 </div>
                 <a href="{{ route('acara.index') }}">
                     ...
                     <button class="btn-line flex items-center gap-2"><span class="hidden md:block">Lihat </span>
                         Lainnya
         ...
         <section class="container mx-auto px-6 py-16 mt-[10%] relative z-[4]" data-aos="fade-up"
             ...
             <div class="lg:flex gap-5 justify-between  ">
                 ...
                 <div class="    bg-zinc-100 px-10 py-10 w-[30%] rounded-3xl">
                     <div class="flex justify-between items-center">
                         <h1 class=" text-xl font-bold">Pengguna Terbaru</h1>
         ...
         <!-- =================================================================== -->
         <div
             class="w-[90%] lg:w-[80%]  mx-auto relative z-10  grid md:grid-cols-2 row rounded-3xl bg-zinc-900  px-[5%] py-7 items-center text-zinc-50">
             ...
             <div class="flex justify-end order-1 md:order-2 relative">
                 ...
                 <div
                     class="blob h-[120px] w-[120px] md:h-[200px] md:w-[200px] lg:h-[400px] lg:w-[400px]  opacity-30 bg-orange-700 absolute ">
                 </div>
         ...
         <section class="container mt-[10%] mx-auto px-6 py-16">
             <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 ...
                 <div class="flex justify-center relative" data-aos="fade-up" data-aos-duration="1000">
                     ...
                     <div class="blob ww-[400px] lg:w-[600px] opacity-10 bg-orange-600 absolute h-[400px] lg:h-[600px]">
                     </div>
                 </div>
                 <!-- Feature List -->
                 <div class="space-y-8">
